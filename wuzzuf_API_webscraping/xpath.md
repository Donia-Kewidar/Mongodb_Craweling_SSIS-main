Here's how you can organize the provided text into a markdown file:
...
Items are either atomic values or nodes.
...
In this example, the book element is the parent of the title, author, year, and price elements.
...
In this example, the title, author, year, and price elements are all children of the book element.

### Siblings

Nodes that have the same parent.

#### Example: Sibling Nodes
...
In this example, the title, author, year, and price elements are all siblings.
...
In this example, the ancestors of the title element are the book element and the bookstore element.
